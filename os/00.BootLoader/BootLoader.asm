...
.SCREENCLEARLOOP:                   ; 화면을 지우는 루프
    ...
    ;;; set variable before call inturrupt ;;;

    mov ah, 04h

    mov ch, byte[CENTURYNUMBER]
    mov cl, byte[YEARNUMBER]
    mov dh, byte[MONTHNUMBER]
    mov dl, byte[DAYNUMBER]
